...
export function Navbar() {
    ...
    return (
        <ul className={style.ul}>
            ...
            <li className={style.li}><a className={style.a} href="#" data-title="Sobre">Sobre</a></li>
            <li className={style.li}><a className={style.a} href="#" data-title="Músicas">Músicas</a></li>
            <li className={style.li}><a className={style.a} href="#" data-title="Cardapio">Cardápio</a></li>
