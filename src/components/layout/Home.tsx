...
function Home() {
    ...
    return (
        <>
            ...
            <Container fluid="" className={style.texto}>

                &nbsp;&nbsp;&nbsp;&nbsp;Seja bem-vindo(a) ao nosso pub! Com mais de 27 anos de existência, somos uma referências.Nosso menu é uma verdadeira viagem gastronômica pelos quatro cantos do mundo, com pratos inspirados em países como Estados Unidos, Itália, México, Japão, entre outros. Além disso, contamos com uma vasta seleção de bebidas, incluindo cervejas artesanais, vinhos importados e coquetéis exclusivos.<br></br>



                &nbsp;&nbsp;&nbsp;&nbsp;Com um ambiente descontraído e acolhedor, nosso pub é o lugar ideal para se reunir com amigos e familiares, seja para um happy hour, um jantar descontraído ou para celebrar ocasiões especiais.
            ...
            <Container style={{ width: '70%' }} >
                ...
                <Container style={{ textAlign: 'center' }}>
                    <Link to="/Musicas"><Button variant="info">VEJA MAIS</Button></Link>
                </Container>
            ...
            <Container style={{ textAlign: 'center', marginBottom: '5%' }}>
                <Link to="/Cardapio"><Button variant="info">VEJA MAIS</Button></Link>
            </Container>
            <Footer/>
        </>
