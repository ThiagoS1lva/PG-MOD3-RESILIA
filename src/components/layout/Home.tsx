            ...
            <Container fluid="">
                <Row>
                    <Col className={style.texto}>
                        &nbsp;&nbsp;&nbsp;&nbsp;Seja bem-vindo(a) ao nosso pub! Com mais de 27 anos de existência, somos uma referências.Nosso menu é uma verdadeira viagem gastronômica pelos quatro cantos do mundo, com pratos inspirados em países como Estados Unidos, Itália, México, Japão, entre outros. Além disso, contamos com uma vasta seleção de bebidas, incluindo cervejas artesanais, vinhos importados e coquetéis exclusivos.
                    </Col>
